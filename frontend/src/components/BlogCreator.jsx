        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-xl font-bold text-white">Yangi Blog Yaratish</h1>
            </div>
            <div className="flex items-center space-x-4">
    ...
    <div>
      <div className="flex gap-1 mb-2 flex-wrap">
        <button
          ...
          className="bg-gray-700 hover:bg-gray-600 text-white p-1 rounded transition text-xs"
          title="Sarlavha 1"
        >
          <Heading1 size={12} />
        </button>
      ...
      <textarea
        ...
        className="w-full bg-gray-900/50 text-white rounded-lg p-3 min-h-[120px] border border-gray-600 focus:border-blue-500 focus:outline-none resize-none text-sm font-sans"
        placeholder="Matn kiriting... (Markdown va HTML formatlarini qo'llab-quvvatlaydi)"
      />
    </div>
  );
}
  ...
  return (
    <div className="relative">
      <textarea
        value={code}
        onChange={handleChange}
        className="w-full bg-gray-900 text-green-300 rounded-lg p-3 min-h-[150px] border border-gray-600 focus:border-green-500 focus:outline-none font-mono text-sm resize-none"
  ...
  return (
    <div>
      ...
      <button
        ...
        className="bg-purple-600 hover:bg-purple-700 text-white px-3 py-2 rounded-lg mb-3 flex items-center gap-2 transition text-sm"
      >
        <Plus size={16} />
          ...
          <div key={file.id} className="relative bg-gray-900/50 rounded-lg overflow-hidden border border-gray-700 group max-w-xs w-full">
            <div className="absolute top-2 right-2 z-10 flex gap-1 opacity-0 group-hover:opacity-100 transition">
              <button
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white p-1.5 rounded transition text-xs"
                title="Yuklab olish"
              >
                <Download size={12} />
              </button>
              <button
                ...
                className="bg-red-600 hover:bg-red-700 text-white p-1.5 rounded transition text-xs"
                title="O'chirish"
              >
                <X size={12} />
              </button>
            ...
            {file.type.startsWith('image/') ? (
              <img 
                src={file.data} 
                alt={file.name} 
                className="w-full h-48 object-cover cursor-pointer mx-auto"
